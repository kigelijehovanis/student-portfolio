...
if page == "Home":
    ...
    st.image("https://via.placeholder.com/150", width=150, caption="Default Image")
    ...
    st.download_button(label="📄 Download my CV", data=resume_bytes, file_name="resume.pdf", mime="application/pdf")
